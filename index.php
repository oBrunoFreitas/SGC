            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                Psicólogos <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="index.php?pagina=listar_medico.php">Listar Psicólogos</a></li>
                                <li><a href="index.php?pagina=incluir_medico.php">Incluir Psicólogos</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
...
<div class="footer ">
            <div class="container">
                <hr>
                <p class="text-muted text-center"><a href="" target="_blank">&copy; 2019 | Bruno Freitas</a></p>
            </div>
        </div>
