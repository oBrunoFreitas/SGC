<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($especialidade->getAtualizacaoEfetuada()) {
            ...
            http://localhost/SGC/index.php?pagina=listar_especialidade.php'
            ";
        } else {
            echo '
            <center>
            ...
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=
            http://localhost/SGC/index.php?pagina=atualizar_especialidade.php&idEspecialidade={$especialidade->getIdEspecialidade()}'
            ";
        }
    }
